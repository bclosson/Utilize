      ...
      <div className="col s6 m7">
        <div className="card">
          <div className="card-image">
            <img src={ this.state.recipes.hits[0] ? this.state.recipes.hits[0]['recipe']['image'] : 'image not available' } alt=""/>
            <span className="card-title">{ this.state.recipes.hits[0] ? this.state.recipes.hits[0]['recipe']['label'] : 'does not exist' }</span>
          </div>
          <div className="card-content">
            <h1></h1>
            <p>Servings: { this.state.recipes.hits[0] ? this.state.recipes.hits[0]['recipe']['yield'] : 'does not exist' }</p>
            <p>Calories: {dishes[calories]}</p>
            <p>Calories: { this.state.recipes.hits[0] ? this.state.recipes.hits[0]['recipe']['calories'] : 'does not exist'}</p>
